...
- The data contained 2139 instances, include integer and categorical variables
...
2. What clinical features (e.g., CD4 counts) significantly impact survival outcomes for patients undergoing different treatments?

- Symptom
- CD4 counts at the baseline and 20 weeks.
- Karnofsky score
...
4. What are the most important indicators/features that better give the diagnosis result?
