...
We first fit in the decision tree model with all the features, the accuracy achieved **73.94%** wiith sensitivity of 77.14$, specificity 70.00%.
...
## Conclusion
With the selected feature from the feature importance function of decision, the accuracy, sensitivity and specificity score has not obviously improve. Thus we still decide to use the model fitted with all the features as our model outcome with an overall accuracy of **73.94%** wiith sensitivity of 77.14$, specificity 70.00%.